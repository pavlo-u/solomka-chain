...
mod tests {
    use {
        ...
        solomka_sdk::{account::Account, pubkey::Pubkey, signature::Signer},
    ...
    fn test_aggregate_commitment_validity() {
        ...
        let sk1 = solomka_sdk::pubkey::new_rand();
        let pk1 = solomka_sdk::pubkey::new_rand();
        let mut vote_account1 =
            vote_state::create_account(&pk1, &solomka_sdk::pubkey::new_rand(), 0, 100);
        let stake_account1 =
            stake_state::create_account(&sk1, &pk1, &vote_account1, &genesis_config.rent, 100);
        let sk2 = solomka_sdk::pubkey::new_rand();
        let pk2 = solomka_sdk::pubkey::new_rand();
        let mut vote_account2 =
            vote_state::create_account(&pk2, &solomka_sdk::pubkey::new_rand(), 0, 50);
        let stake_account2 =
            stake_state::create_account(&sk2, &pk2, &vote_account2, &genesis_config.rent, 50);
        let sk3 = solomka_sdk::pubkey::new_rand();
        let pk3 = solomka_sdk::pubkey::new_rand();
        let mut vote_account3 =
            vote_state::create_account(&pk3, &solomka_sdk::pubkey::new_rand(), 0, 1);
        ...
        let sk4 = solomka_sdk::pubkey::new_rand();
        let pk4 = solomka_sdk::pubkey::new_rand();
        let mut vote_account4 =
            vote_state::create_account(&pk4, &solomka_sdk::pubkey::new_rand(), 0, 1);
