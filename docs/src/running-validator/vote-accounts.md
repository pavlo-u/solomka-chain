...
1. Create the new validator identity keypair, `solomka-keygen new -o ~/new-validator-keypair.json`.
...
2. Create the new vote authority keypair, `solomka-keygen new -o ~/new-vote-authority.json`.
