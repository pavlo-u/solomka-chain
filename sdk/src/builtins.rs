...
/// mod item_wrapper {
/// use solomka_sdk::keyed_account::KeyedAccount;
/// use solomka_sdk::instruction::InstructionError;
/// use solomka_sdk::pubkey::Pubkey;
/// use solomka_sdk::declare_builtin;
///
...
///
/// # use item_wrapper::id;
/// assert_eq!(id(), solomka_sdk::system_program::ID);
/// ```
#[macro_export]
