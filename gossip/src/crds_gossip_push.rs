...
mod tests {
    ...
    fn test_prune() {
        ...
        let self_id = solomka_sdk::pubkey::new_rand();
        let origin = solomka_sdk::pubkey::new_rand();
        ...
        let low_staked_peers = (0..10).map(|_| solomka_sdk::pubkey::new_rand());
        ...
        let high_staked_peer = solomka_sdk::pubkey::new_rand();
    ...
    fn test_process_push_old_version() {
        let crds = RwLock::<Crds>::default();
        let push = CrdsGossipPush::default();
        let mut ci = ContactInfo::new_localhost(&solomka_sdk::pubkey::new_rand(), 0);
        ci.wallclock = 1;
    ...
    fn test_refresh_active_set() {
        ...
        let value1 = ContactInfo::new_localhost(&solomka_sdk::pubkey::new_rand(), 0);
        ...
        let mut value2 = ContactInfo::new_localhost(&solomka_sdk::pubkey::new_rand(), 0);
    ...
    fn test_active_set_refresh_with_bank() {
        ...
        for i in 1..=100 {
            let peer = CrdsValue::new_unsigned(CrdsData::LegacyContactInfo(
                ContactInfo::new_localhost(&solomka_sdk::pubkey::new_rand(), time),
            ));
    ...
    fn test_new_push_messages() {
        ...
        let push = CrdsGossipPush::default();
        let mut ping_cache = new_ping_cache();
        let peer = ContactInfo::new_localhost(&solomka_sdk::pubkey::new_rand(), 0);
