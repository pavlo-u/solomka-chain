...
mod tests {
    ...
    fn test_authorized_authorize() {
        let staker = solomka_sdk::pubkey::new_rand();
    ...
    fn test_authorized_authorize_with_custodian() {
        ...
        let invalid_custodian = solomka_sdk::pubkey::new_rand();
        let mut authorized = Authorized::auto(&staker);
        let mut signers = HashSet::new();
        signers.insert(staker);
    ...
    fn test_dbg_stake_minimum_balance() {
        ...
        panic!(
            ...
            minimum_balance,
            minimum_balance as f64 / solomka_sdk::native_token::LAMPORTS_PER_SOL as f64
        );
    }
    ...
    fn test_calculate_lamports_per_byte_year() {
        ...
        let even_larger_data = solomka_sdk::system_instruction::MAX_PERMITTED_DATA_LENGTH;
