...
//! documentation for [`secp256k1_instruction`] in the `solomka-sdk` crate.
//!
//! [`secp256k1_instruction`]: https://docs.rs/solomka-sdk/latest/solomka_sdk/secp256k1_instruction/index.html
