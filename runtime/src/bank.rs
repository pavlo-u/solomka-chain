...
#[allow(deprecated)]
use solomka_sdk::recent_blockhashes_account;
pub use solomka_sdk::reward_type::RewardType;
use {
    crate::{
...
impl Bank {
    ...
    fn use_multi_epoch_collection_cycle(&self, epoch: Epoch) -> bool {
        ...
        #[cfg(not(test))]
        if self.slot_count_per_normal_epoch() == solomka_sdk::epoch_schedule::MINIMUM_SLOTS_PER_EPOCH
        {
            return false;
        }
    ...
    fn reconfigure_token2_native_mint(&mut self) {
        ...
        if reconfigure_token2_native_mint {
            let mut native_mint_account = solomka_sdk::account::AccountSharedData::from(Account {
                ...
                self.get_account_with_fixed_root(&inline_spl_token::native_mint::id())
            {
                ...
                if existing_native_mint_account.owner() == &solomka_sdk::system_program::id() {
...
pub mod test_utils {
    use {super::Bank, solomka_sdk::hash::hashv};
...
pub(crate) mod tests {
    ...
    #[allow(clippy::float_cmp)]
    fn test_bank_new() {
        let dummy_leader_pubkey = solomka_sdk::pubkey::new_rand();
    ...
    fn test_rent_distribution() {
        ...
        let validator_1_pubkey = solomka_sdk::pubkey::new_rand();
        ...
        let validator_2_pubkey = solomka_sdk::pubkey::new_rand();
        ...
        let validator_3_pubkey = solomka_sdk::pubkey::new_rand();
    ...
    fn test_distribute_rent_to_validators_overflow() {
        ...
        let validator_pubkey = solomka_sdk::pubkey::new_rand();
    ...
    fn test_rent_exempt_executable_account() {
        ...
        let account_pubkey = solomka_sdk::pubkey::new_rand();
        let account_balance = 1;
        let mut account =
            AccountSharedData::new(account_balance, 0, &solomka_sdk::pubkey::new_rand());
    ...
    fn test_rent_eager_across_epoch_without_gap_under_multi_epoch_cycle() {
        let leader_pubkey = solomka_sdk::pubkey::new_rand();
    ...
    fn map_to_test_bad_range() -> std::collections::BTreeMap<Pubkey, i8> {
        ...
        map.insert(solomka_sdk::pubkey::new_rand(), 1);
        map
    }
    ...
    fn test_rent_eager_collect_rent_in_partition() {
        ...
        let zero_lamport_pubkey = solomka_sdk::pubkey::new_rand();
        let rent_due_pubkey = solomka_sdk::pubkey::new_rand();
        let rent_exempt_pubkey = solomka_sdk::pubkey::new_rand();
    ...
    fn do_test_bank_update_rewards_determinism() -> u64 {
        ...
        let vote_id = solomka_sdk::pubkey::new_rand();
        let mut vote_account =
            vote_state::create_account(&vote_id, &solomka_sdk::pubkey::new_rand(), 0, 100);
    ...
    fn test_transfer_to_sysvar() {
        ...
        let normal_pubkey = solomka_sdk::pubkey::new_rand();
    ...
    fn test_bank_tx_fee() {
        ...
        let leader = solomka_sdk::pubkey::new_rand();
        let GenesisConfigInfo {
            mut genesis_config,
            mint_keypair,
            ..
    ...
    fn test_readonly_accounts() {
        let GenesisConfigInfo {
            ...
            mint_keypair,
            ..
        } = create_genesis_config_with_leader(500, &solomka_sdk::pubkey::new_rand(), 0);
        let bank = Bank::new_for_tests(&genesis_config);

        let vote_pubkey0 = solomka_sdk::pubkey::new_rand();
        let vote_pubkey1 = solomka_sdk::pubkey::new_rand();
        let vote_pubkey2 = solomka_sdk::pubkey::new_rand();
    ...
    fn test_readonly_relaxed_locks() {
        ...
        let key3 = solomka_sdk::pubkey::new_rand();
    ...
    fn test_bank_hash_internal_state() {
        ...
        let pubkey2 = solomka_sdk::pubkey::new_rand();
    ...
    fn test_bank_hash_internal_state_verify() {
        ...
        let bank2 = Bank::new_from_parent(&bank0, &solomka_sdk::pubkey::new_rand(), 1);
        ...
        bank2.update_accounts_hash();
        assert!(bank2.verify_bank_hash(VerifyBankHash::default_for_test()));
        let bank3 = Bank::new_from_parent(&bank0, &solomka_sdk::pubkey::new_rand(), 2);
    ...
    fn test_hash_internal_state_order() {
        ...
        let bank1 = Bank::new_for_tests(&genesis_config);
        assert_eq!(bank0.hash_internal_state(), bank1.hash_internal_state());
        let key0 = solomka_sdk::pubkey::new_rand();
        let key1 = solomka_sdk::pubkey::new_rand();
    ...
    fn test_bank_update_sysvar_account() {
        ...
        let dummy_clock_id = solomka_sdk::pubkey::new_rand();
    ...
    fn test_bank_inherit_tx_count() {
        ...
        // Bank 2
        let bank2 = Bank::new_from_parent(&bank0, &solomka_sdk::pubkey::new_rand(), 2);
        ...
        let bank6 = Bank::new_from_parent(&bank1, &solomka_sdk::pubkey::new_rand(), 3);
        assert_eq!(bank1.transaction_count(), 1);
    ...
    fn test_bank_vote_accounts() {
        let GenesisConfigInfo {
            ...
            mint_keypair,
            ..
        } = create_genesis_config_with_leader(500, &solomka_sdk::pubkey::new_rand(), 1);
        let bank = Arc::new(Bank::new_for_tests(&genesis_config));
    ...
    fn test_is_delta_with_no_committables() {
        ...
        assert_eq!(
            bank.transfer(10_001, &mint_keypair, &solomka_sdk::pubkey::new_rand()),
            Err(TransactionError::InstructionError(
                0,
                SystemError::ResultWithNegativeLamports.into(),
            ))
    ...
    fn test_bank_get_program_accounts() {
        ...
        assert!(
            genesis_accounts
                .iter()
                .any(|(pubkey, _, _)| solomka_sdk::sysvar::is_sysvar_id(pubkey)),
            "no sysvars found"
        );
    ...
    fn test_transaction_with_duplicate_accounts_in_instruction() {
        ...
        let to_pubkey = solomka_sdk::pubkey::new_rand();
    ...
    fn test_account_ids_after_program_ids() {
        ...
        tx.message.account_keys.push(solomka_sdk::pubkey::new_rand());
    ...
    fn test_fuzz_instructions() {
        ...
        let program_keys: Vec<_> = (0..max_programs)
            .enumerate()
            .map(|i| {
                let key = solomka_sdk::pubkey::new_rand();
    ...
    fn test_same_program_id_uses_unqiue_executable_accounts() {
        ...
        // Add a new program
        let program1_pubkey = solomka_sdk::pubkey::new_rand();
        bank.add_builtin("program", &program1_pubkey, nested_processor);

        // Add a new program owned by the first
        let program2_pubkey = solomka_sdk::pubkey::new_rand();
    ...
    fn test_add_builtin_loader_no_overwrite() {
        ...
        let slot = 123;
        let loader_id = solomka_sdk::pubkey::new_rand();
    ...
    fn test_reconfigure_token2_native_mint() {
        ...
        let mut genesis_config =
            create_genesis_config_with_leader(5, &solomka_sdk::pubkey::new_rand(), 0).genesis_config;
    ...
    fn test_ensure_no_storage_rewards_pool() {
        ...
        let reward_pubkey = solomka_sdk::pubkey::new_rand();
        genesis_config.rewards_pools.insert(
            reward_pubkey,
            Account::new(u64::MAX, 0, &solomka_sdk::pubkey::new_rand()),
        );
        let bank0 = Bank::new_for_tests(&genesis_config);
    ...
    fn test_bank_executor_cache() {
        ...
        let key2 = solomka_sdk::pubkey::new_rand();
        let key3 = solomka_sdk::pubkey::new_rand();
        let key4 = solomka_sdk::pubkey::new_rand();
        let key5 = solomka_sdk::pubkey::new_rand();
        ...
        // Check inheritance
        let bank = Bank::new_from_parent(&Arc::new(bank), &solomka_sdk::pubkey::new_rand(), 1);
        let executors = bank.get_executors(accounts);
            ...
            ) + std::marker::Send,
    {
        ...
        let all_pubkeys: Vec<Pubkey> = std::iter::repeat_with(solomka_sdk::pubkey::new_rand)
            .take(total_pubkeys)
            .collect();
    ...
    fn test_get_inflation_start_slot_devnet_testnet() {
        let GenesisConfigInfo {
            mut genesis_config, ..
        } = create_genesis_config_with_leader(42, &solomka_sdk::pubkey::new_rand(), 42);
        genesis_config
            .accounts
    ...
    fn test_call_precomiled_program() {
        ...
        let instruction = solomka_sdk::secp256k1_instruction::new_secp256k1_instruction(
            &secp_privkey,
            message_arr,
        );
        let tx = Transaction::new_signed_with_payer(
        ...
        let message_arr = b"hello";
        let instruction =
            solomka_sdk::ed25519_instruction::new_ed25519_instruction(&privkey, message_arr);
        let tx = Transaction::new_signed_with_payer(
            &[instruction],
            Some(&mint_keypair.pubkey()),
            &[&mint_keypair],
    ...
    fn test_an_empty_instruction_without_program() {
        let (genesis_config, mint_keypair) = create_genesis_config(1);
        let destination = solomka_sdk::pubkey::new_rand();
    ...
    fn test_max_accounts_data_size_exceeded() {
        ...
        assert!(matches!(
            ...
            Err(TransactionError::InstructionError(
                _,
                solomka_sdk::instruction::InstructionError::MaxAccountsDataSizeExceeded,
            ))
        ));
    }
    ...
    fn test_invalid_rent_state_changes_fee_payer() {
        ...
        genesis_config.fee_rate_governor = FeeRateGovernor::new(
            solomka_sdk::fee_calculator::DEFAULT_TARGET_LAMPORTS_PER_SIGNATURE,
            solomka_sdk::fee_calculator::DEFAULT_TARGET_SIGNATURES_PER_SLOT,
        );
    ...
    fn test_rent_state_incinerator() {
        ...
        for amount in [rent_exempt_minimum - 1, rent_exempt_minimum] {
            bank.transfer(amount, &mint_keypair, &solomka_sdk::incinerator::id())
                .unwrap();
        }
    }
    ...
    fn test_resize_and_rent() {
        ...
        let rent_paying_pubkey = solomka_sdk::pubkey::new_rand();
