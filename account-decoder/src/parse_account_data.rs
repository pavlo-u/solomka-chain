use {
    ...
    inflector::Inflector,
    serde_json::Value,
    solomka_sdk::{instruction::InstructionError, pubkey::Pubkey, stake, system_program, sysvar},
...
lazy_static! {
    ...
    static ref BPF_UPGRADEABLE_LOADER_PROGRAM_ID: Pubkey = solomka_sdk::bpf_loader_upgradeable::id();
...
mod test {
    ...
    fn test_parse_account_data() {
        ...
        let other_program = solomka_sdk::pubkey::new_rand();
        let data = vec![0; 4];
