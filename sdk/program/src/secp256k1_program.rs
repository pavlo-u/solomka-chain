...
//! program's usage can be found in [`solomka_sdk::secp256k1_instruction`].
//!
//! [`solomka_sdk::secp256k1_instruction`]: https://docs.rs/solomka-sdk/latest/solomka_sdk/secp256k1_instruction/index.html
