...
pub fn test_process_distribute_tokens_with_client(
    ...
    let alice_pubkey = solomka_sdk::pubkey::new_rand();
...
mod tests {
    ...
    fn test_apply_previous_transactions() {
        let alice = solomka_sdk::pubkey::new_rand();
        let bob = solomka_sdk::pubkey::new_rand();
    ...
    fn test_set_split_stake_lockup() {
        ...
        let stake_account_address = solomka_sdk::pubkey::new_rand();
        let new_stake_account_address = solomka_sdk::pubkey::new_rand();
    ...
    fn initialize_check_payer_balances_inputs(
        ...
        let recipient = solomka_sdk::pubkey::new_rand();
        let allocations = vec![Allocation {
    ...
    fn test_check_payer_balances_distribute_stakes_single_payer() {
        ...
        let expensive_allocations = vec![Allocation {
            recipient: solomka_sdk::pubkey::new_rand().to_string(),
