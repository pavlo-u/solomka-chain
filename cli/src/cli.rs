...
mod tests {
    ...
    fn test_generate_unique_signers() {
        ...
        assert_eq!(
            signer_info.index_of(Some(solomka_sdk::pubkey::new_rand())),
            None
        );
    ...
    fn test_cli_parse_command() {
        ...
        let from_pubkey = Some(solomka_sdk::pubkey::new_rand());
    ...
    fn test_cli_process_command() {
        ...
        let new_authorized_pubkey = solomka_sdk::pubkey::new_rand();
        ...
        let stake_account_pubkey = solomka_sdk::pubkey::new_rand();
        ...
        let stake_account_pubkey = solomka_sdk::pubkey::new_rand();
        let source_stake_account_pubkey = solomka_sdk::pubkey::new_rand();
