...
solomka-keygen new -o "$dummy_keypair" --no-passphrase --force --silent
...
solomka-keygen new -o "$online_system_account_keypair" --no-passphrase --force --silent
solomka-keygen new -o "$online_nonce_account_keypair" --no-passphrase --force --silent

online_system_account_pubkey="$(solomka-keygen pubkey $online_system_account_keypair)"
nonce_account_pubkey="$(solomka-keygen pubkey $online_nonce_account_keypair)"
...
solomka-keygen new -o "$offline_system_account_keypair" --no-passphrase --force --silent
solomka-keygen new -o "$offline_staker_keypair" --no-passphrase --force --silent
solomka-keygen new -o "$offline_withdrawer_keypair" --no-passphrase --force --silent
solomka-keygen new -o "$offline_custodian_keypair" --no-passphrase --force --silent

offline_system_account_pubkey="$(solomka-keygen pubkey $offline_system_account_keypair)"
offline_withdrawer_pubkey="$(solomka-keygen pubkey $offline_withdrawer_keypair)"
offline_staker_pubkey="$(solomka-keygen pubkey $offline_staker_keypair)"
offline_custodian_pubkey="$(solomka-keygen pubkey $offline_custodian_keypair)"
...
solomka-keygen new -o "$stake_account_keypair" --no-passphrase --force --silent
stake_account_address="$(solomka-keygen pubkey $stake_account_keypair)"
...
solomka-keygen new -o $split_stake_account_keypair --no-passphrase --force --silent
split_stake_account_address=$(solomka-keygen pubkey $split_stake_account_keypair)
