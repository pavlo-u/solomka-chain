...
#[cfg(test)]
use solomka_sdk::epoch_schedule::MAX_LEADER_SCHEDULE_EPOCH_OFFSET;
use {
...
impl VoteState {
    ...
    fn get_max_sized_vote_state() -> VoteState {
        ...
        for i in 0..=MAX_LEADER_SCHEDULE_EPOCH_OFFSET {
            authorized_voters.insert(i, solomka_sdk::pubkey::new_rand());
        }
...
pub mod serde_compact_vote_state_update {
    use {
        ...
        solomka_sdk::{serde_varint, short_vec},
    };
...
mod tests {
    ...
    fn test_get_and_update_authorized_voter() {
        let original_voter = solomka_sdk::pubkey::new_rand();
        ...
        let new_authorized_voter = solomka_sdk::pubkey::new_rand();
        vote_state
    ...
    fn test_set_new_authorized_voter() {
        ...
        let new_voter = solomka_sdk::pubkey::new_rand();
        ...
        let new_voter2 = solomka_sdk::pubkey::new_rand();
        vote_state
        ...
        let new_voter3 = solomka_sdk::pubkey::new_rand();
        vote_state
    ...
    fn test_minimum_balance() {
        let rent = solomka_sdk::rent::Rent::default();
