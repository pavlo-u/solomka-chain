...
- Instructions: [StakeInstruction](https://docs.rs/solomka-sdk/VERSION_FOR_DOCS_RS/solomka_sdk/stake/instruction/enum.StakeInstruction.html)
...
- Instructions: [LoaderInstruction](https://docs.rs/solomka-sdk/VERSION_FOR_DOCS_RS/solomka_sdk/loader_upgradeable_instruction/enum.UpgradeableLoaderInstruction.html)
